...
class ConfirmationsControllerTest < ActionController::TestCase
  ...
  test "should create confirmation" do
    assert_difference('Confirmation.count') do
      post :create, confirmation: { confirmed: @confirmation.confirmed, message_id: @confirmation.message_id, responder_id: @confirmation.responder_id, timestamp: @confirmation.timestamp }
    end
  ...
  test "should update confirmation" do
    put :update, id: @confirmation, confirmation: { confirmed: @confirmation.confirmed, message_id: @confirmation.message_id, responder_id: @confirmation.responder_id, timestamp: @confirmation.timestamp }
    assert_redirected_to confirmation_path(assigns(:confirmation))
  end
